...
- [ ] **Knowledge browse UI** — graph visualization exists but isn't the right entry point; add a searchable list/table of KG nodes so users can find what the system learned
